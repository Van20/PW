package smktelkom_mlg.sch.id.mywallet.Promo_screen.Lazada_screen;
...
public class LazadaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lazada);
